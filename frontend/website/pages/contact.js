            ...
            <div className="layout-wrapper">
                ...
                <div className="contact-container">
                    <div className="contact-section">
                        ...
                        <p>If you have any comments, ideas, critiques, or you just want to say hi, don’t hesitate to send me an email at julian@methodize.co!</p>
                    </div>
                    <div className="contact-section">
                        <h2>Around the Web</h2>
                        <ul>
                            <li><strong>Email</strong>: julian@methodize.co</li>
                            <li><strong>GitHub</strong>: <a href="https://github.com/coder-rocket-fuel">Coder Rocket Fuel</a></li>
                            <li><strong>Twitter</strong>: <a href="https://twitter.com/methodize">Coder Rocket Fuel Twitter Page</a></li>
                        </ul>
                    </div>
                </div>
                <Footer />
